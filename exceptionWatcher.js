...
(function ($w) {
   ...
   // TODO: 外界配置对象 待完成
    ...
    function _http_excption_bridge(xhr, time) {
      var url, query, status, statusText, responseText, method, host, key, totalTime;
  ...
  // TODO: _init_hash_watcher 
    ...
    function createErrorEvents(type, argus, wacther_type, tags) {
      ...
      !modified_text && (modified_text = (typeof argus[0] == 'object' ?  argus[0].message.substring(0, 50) + '...' : argus[0].toString().substring(0, 50) + '...'));
    ...
    function _mounte_helper() {
      ...
      $w.ExceptionWatcher = {
        showDevLogger: function () {
          console.warn('[ExceptionWatcher log] dev logger has been opened! Its will be show current log on any exception encounter!')
